...
{"score": <1-5 integer>, "per_criterion": {"boundary_accuracy": <1-5 integer>, "clinical_reasoning": <1-5 integer>, "granularity": <1-5 integer>, "completeness": <1-5 integer>}, "flagged": <true|false>, "reasoning": "<explanation string>"}
